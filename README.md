...
- **Chicago Skyline** — eight two-minute studies with authored daylight, warm daylight, sunset and night presentations. An eastward Oak Park telephoto panorama and elevated river views above Kinzie Street Bridge and Ping Tom Memorial Park complement the Adler, North Avenue and offshore compositions. It follows Willis Tower in the Chicago demo and uses the same resident geometry. The western foreground is generalized land; the intervening western neighborhoods have not been built out. [Skyline references and lighting](docs/SKYLINE.md) · [Western and river viewpoint research](docs/SKYLINE-REFERENCE-UPDATE.md).
