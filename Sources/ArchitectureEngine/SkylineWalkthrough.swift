...
enum SkylineWalkthrough {
    ...
    static func pose(view: Int, seconds: Double) -> CameraPose {
        ...
        switch index {
        case 0: keys += [K(40,V(2580,14,1150),SkylineScene.acrossWaterTarget,36),K(80,V(2770,24,980),SkylineScene.acrossWaterTarget,35),K(120,V(2860,38,720),SkylineScene.acrossWaterTarget,36)]
        ...
        case 4: keys += [K(40,V(-263,19,-1040),V(-181,37,-640),63),K(80,V(-244,19,-965),V(-175,34,-620),62),K(120,V(-220,22,-890),V(-170,32,-580),64)]
