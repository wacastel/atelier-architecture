...
enum SkylineScene {
    ...
    static let preferredLighting = [3,1,3,2,0,1,0,2]
    ...
    static let stops: [TourStop] = [
        TourStop(id:0,title:"The city across the water",subtitle:"ADLER LAKEFRONT · WILLIS AT SUNSET",detail:"Willis Tower anchors the center of this low waterfront panorama. Rose and amber sunset colors warm the skyline and reflect across the open water, with building lights off for the opening study. The gentle orbit and guided flight keep the tower at the heart of the composition.",pose:pose(V(2410,8,1250),acrossWaterTarget,37)),
        ...
        TourStop(id:2,title:"Sunset behind the skyline",subtitle:"ADLER PANORAMA · AMBER, ROSE & BLUE",detail:"A low west-northwest sun warms the sky behind the buildings. The directional sunset gradient lights and reflects in the scene; building lights can be enabled in Render Settings. This is an authored late-day atmosphere informed by skyline photographs, not a date-specific solar simulation.",pose:pose(V(2750,12,1600),V(720,150,-900),36)),
        ...
        TourStop(id:4,title:"The river leads downtown",subtitle:"NORTH BRANCH · BETWEEN THE TOWERS",detail:"Fly low above the North Branch from Kinzie toward Wolf Point in warm golden-hour light. Follow the mapped channel between Fulton House and the riverfront towers, with close façades framing the water and the river junction ahead. This is a cinematic flight above the river, not a public walking route.",pose:pose(V(-283,20,-1110),V(-190,40,-650),64)),
