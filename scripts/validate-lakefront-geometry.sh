...
swiftc -O \
  ...
  Sources/ArchitectureEngine/NorthSideEnvironment.swift Sources/ArchitectureEngine/ChicagoEnvironment.swift Sources/ArchitectureEngine/NavyPierContext.swift \
