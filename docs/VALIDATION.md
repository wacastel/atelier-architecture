...
**Native UI interaction remains unverified while the Mac is locked, and new demo-video export/decoding remains pending for 1.9 at this report stage.** Earlier native and media records below retain their original release scope and must not be read as completed 1.9 checks.
