...
Recorded 8 September 2026 on the local Apple M3 Ultra Mac Studio with 512 GB unified memory. The current release is **1.8.0 / build 9**. Earlier sections preserve their original measurements and limitations.
